...
class GoogleNewsLib
{
     ...
     */
    public static function getUrl( string $keyword = null, ?string $after, ?string $before ) : ?string
    {
        //検索文字列の作成
        $q = ($after ? "after:{$after}+" : "") . 
     ...
     */
    public static function getNews( string $keyword = null, ?string $after, ?string $before ) : ?string
    {
        //URLの作成
        $url = self::getUrl($keyword, $after, $before);
